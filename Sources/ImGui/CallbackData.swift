...
public struct ImGuiCustomSizeCallbackData {
    ...
    internal init(userData: Any, position: CImVec2, currentSize: CImVec2, _desiredSize: UnsafeMutablePointer<CImVec2>) {
...
public struct ImGuiInputTextCallbackData {
    ...
    public let eventFlag: CImGuiInputTextFlags

    /// Read-only. What user passed to InputText()
    public let flags: CImGuiInputTextFlags
    ...
    public var eventChar: Character {
        get {
            .init(.init(self._eventChar.pointee))
        }
        set {
...
public struct ImGuiCustomInputTextCallbackData {
    /// Read-only. One ImGuiInputTextFlags_Callback*
    public let eventFlag: CImGuiInputTextFlags
    ...
    internal let _eventChar: UnsafeMutablePointer<CImWchar>
    ...
    internal init(eventFlag: CImGuiInputTextFlags, flags: CImGuiInputTextFlags, userData: Any, _eventChar: UnsafeMutablePointer<CImWchar>, eventKey: CImGuiKey, _buf: UnsafeMutablePointer<UnsafeMutablePointer<Int8>>, _bufTextLength: UnsafeMutablePointer<Int32>, _bufSize: Int32, _bufDirty: UnsafeMutablePointer<Bool>, _cursorPos: UnsafeMutablePointer<Int32>, _selectionStart: UnsafeMutablePointer<Int32>, _selectionEnd: UnsafeMutablePointer<Int32>) {
        self.eventFlag = eventFlag
        self.flags = flags
        self.userData = userData
        self._eventChar = _eventChar
